                                ...
                                <div class="form-group col-4">
                                    ...
                                    <div class="">
                                        <input type="number" style="width:300px" class="form-control text-center"
                                            name="receiverId" placeholder="@lang('site.Reciever_Registration_Number_ID')" value="{{ $com->tax_id }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <div class="">
                                        <input type="text" class="form-control text-center" name="receiverBuildingNumber"
                                            placeholder="@lang('site.Building_Name_No')" value="{{ $com->buildingNumber }}">
                                    </div>
                                </div>
                        ...
                        @else
                            ...
                            <div class="invoice-address-client-fields">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <label for="payment-method-country" class="form-label">@lang('site.Document Type')
                                        </label>
                                        @livewire('type')
                                    </div>
                        ...
                        <div class="row">
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                                                                <label for="TotalTaxableFees"
                                                                    class="form-label">@lang("site.Total Taxable Fees")</label>
                                                                <input type="number" readonly class="form-control"
                                                                    step="any" name="t2Amount[]" id="t2"
                                                                    onkeyup="findTotalt2Amount()"
                                                                    onmouseover="findTotalt2Amount()" placeholder="@lang("site.Total Taxable Fees")">
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label for="Totalt4Amount"
                                                                    class="form-label">@lang("site.Total T4 Amount")</label>
                                                                <input type="number" class="form-control"
                                                                    name="t4Amount[]" readonly id="t4Amount"
                                                                    onkeyup="findTotalt4Amount()"
                                                                    onmouseover="findTotalt4Amount()" placeholder="@lang("site.Total T4 Amount")">
                                                            </div>
                                                        </div>
                                                        <div class="row g-3">
                                                            <div class="col-md-6">
                            ...
                            <div class="col-lg-4" style="margin-top: -120px">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label for="findTotalt2Amount" class="form-label">@lang("site.Total T2 Amount")</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="findTotalt4Amount" class="form-label">@lang("site.Total T4 Amount")</label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="findTotalNetAmount" class="form-label">@lang("site.Total Net Amount")</label>
                                        ...
                                        <div class="col-12">
                                            <label for="ExtraInvoiceDiscount" class="form-label">@lang("site.Extra Invoice Discount") </label>
                                        ...
                                        <div class="col-12">
                                            <label for="findTotalAmount" class="form-label">@lang("site.Total (befor discount)")
                                            </label>
                                        ...
                                        <div class="col-12">
                                            <label for="findTotalAmount" class="form-label">@lang("site.Total (after discount)")
                                            </label>
                                            <input type="number" class="form-control"
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary">@lang("site.Submit Document")</button>
                                            </div>
