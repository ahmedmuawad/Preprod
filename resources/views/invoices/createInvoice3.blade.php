                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text"
                                                                class="form-control form-control-sm text-center"
                                                                name="bankAccountIBAN" placeholder="@lang("site.Bank Account IBAN")" value="EG600036000100011018180034373">
                                                ...
                                                <div class="border border-3 p-4 rounded">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="itemCode[]" id="itemCode"
                                                            class="form-control single-select" placeholder="@lang("site.chooseItem")">
                                                    ...
                                                    <div class=" row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" class="form-control" name="rate[]"
                                                                ...
                                                                onmouseover="findTotalt2Amount()" placeholder="@lang("site.Tax_added")" value="0">
                                                        </div>
                                                    </div>
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="number" class="form-control" name="t4rate[]"
                                                                ...
                                                                onmouseover="findTotalt4Amount()" placeholder="@lang("site.Tax t4 Value")"  value="0">
                                                        </div>
                                                    </div>
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
